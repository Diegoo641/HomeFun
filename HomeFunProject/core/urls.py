...
from core.views import home ,gasto_comun, registro,agregar_administrador, modificar_res_espacio_comun,\
cancelarReservaEspacioComun,panel_admin, admin_espacios_comunes, eliminarEspacioComun, modificar_espacio_comun,\
crear_espacio_comun, habilitarEspacioComun,admin_res_espacios_comunes
...
urlpatterns = [
    ...
    path('gasto_comun', gasto_comun, name="gasto_comun"),
